...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    beforeEach(() => {
      process.env = { ...env };
      process.env['CHARTEST_LOG'] = undefined;
    });
    ...
    const forceAPIResponseForClient = async (client: Chartest) => {
    ...
    test('debug logs happen with debug env var', async () => {
      ...
      process.env['CHARTEST_LOG'] = 'debug';
      const client = new Chartest({
        logger: logger,
        username: 'My Username',
        password: 'My Password',
    ...
    test('warn when env var level is invalid', async () => {
      ...
      process.env['CHARTEST_LOG'] = 'not a log level';
      const client = new Chartest({
        logger: logger,
        username: 'My Username',
        password: 'My Password',
      ...
      expect(warnMock).toHaveBeenCalledWith(
        'process.env[\'CHARTEST_LOG\'] was set to "not a log level", expected one of ["off","error","warn","info","debug"]',
      );
    });
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['CHARTEST_BASE_URL'] = undefined;
    });
    ...
    test('empty env variable', () => {
      process.env['CHARTEST_BASE_URL'] = ''; // empty
      const client = new Chartest({ username: 'My Username', password: 'My Password', apiKey: 'My API Key' });
    ...
    test('in request options overridden by env variable', () => {
      process.env['CHARTEST_BASE_URL'] = 'http://localhost:5000/env';
      const client = new Chartest({ username: 'My Username', password: 'My Password', apiKey: 'My API Key' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
  ...
  test('maxRetries option is correctly set', () => {
    ...
    // default
    const client2 = new Chartest({ username: 'My Username', password: 'My Password', apiKey: 'My API Key' });
  ...
  test('with environment variable arguments', () => {
    ...
    process.env['CHARTEST_USERNAME'] = 'My Username';
    process.env['CHARTEST_PASSWORD'] = 'My Password';
    process.env['CHARTEST_API_KEY'] = 'My API Key';
    const client = new Chartest();
  ...
  test('with overridden environment variable arguments', () => {
    // set options via env var
    process.env['CHARTEST_USERNAME'] = 'another My Username';
    process.env['CHARTEST_PASSWORD'] = 'another My Password';
    process.env['CHARTEST_API_KEY'] = 'another My API Key';
    const client = new Chartest({ username: 'My Username', password: 'My Password', apiKey: 'My API Key' });
    expect(client.username).toBe('My Username');
    expect(client.password).toBe('My Password');
    expect(client.apiKey).toBe('My API Key');
